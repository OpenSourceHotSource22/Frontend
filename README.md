...
## 사용 방법
배포된 주소 사용 https://everyteam.netlify.app/ 
1.	회원가입을 한다.
2.	로그인을 한다.
3.	그룹을 만든다.
3-1) 들어가고 싶은 그룹이 있을 시, 코드번호를 받고 코드번호를 입력한다.
4.	왼쪽 그룹설명에서 작성하기 버튼을 눌러 작성할 글의 타입을 고른다.
4-1) post : 제목과 내용을 적어 제출한다.
4-2) meet : 제목과 만날 날짜를 정한다. 가능한 시간을 눌러서 선택한다.
4-2-1) 팀원의 경우 해당 글을 눌러 자신이 가능한 시간을 선택하여 제출한다.
4-3) Role : 원하는 기능을 택한다.
4-3-1) 룰렛 : 역할을 적고 룰렛을 돌리고 제출한다.
4-3-2) 사랑의 작대기 : 원하는 이름과 역할을 적고 , 확인하기 후 제출한다.
5.	생성일별,기능별 버튼으로 확인할 수 있다.
![image](https://user-images.githubusercontent.com/65282581/204095339-e47f302c-399e-40a7-bd9a-0b02792c0d21.png)
...
<img width="283" alt="스크린샷 2022-11-26 오후 11 49 28" src="https://user-images.githubusercontent.com/65282581/204094891-74e5da33-eb56-4218-876b-6dae62b70fd7.png">
...
추가하기 버튼 클릭시 post, whenWeMeet, Role 기능을 사용할 수 있습니다.
 ...
 <img width="539" alt="스크린샷 2022-11-26 오후 11 47 29" src="https://user-images.githubusercontent.com/65282581/204094820-2ad1c12e-5853-4295-bf91-ab5e75689964.png">
